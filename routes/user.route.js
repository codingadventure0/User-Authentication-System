...
/* GET home page. */
router.get('/login', loggedInMiddleware.loggedIn, redirectToProfile, userController.getLoginForm);
router.get('/signup', loggedInMiddleware.loggedIn, redirectToProfile, userController.getSignUpForm);
